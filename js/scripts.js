...
function initTowhub() {
    ...
    if ($(".listing-slider").length > 0) {
        var lsw = new Swiper(".listing-slider .swiper-container", {
            ...
            navigation: {
                nextEl: '.listing-carousel-button.listing-carousel-button-next2',
                prevEl: '.listing-carousel-button.listing-carousel-button-prev2',
            },
            breakpoints: {
                1650: {
                    slidesPerView: 3,
    ...
    if ($(".listing-slider2").length > 0) {
        var lsw = new Swiper(".listing-slider2 .swiper-container", {
            preloadImages: false,
            slidesPerView: 3,
            spaceBetween: 10,
            loop: false,
    ...
    if ($(".listing-slider3").length > 0) {
        var lsw = new Swiper(".listing-slider3 .swiper-container", {
            preloadImages: false,
            slidesPerView: 3,
            spaceBetween: 10,
            loop: false,
            ...
            navigation: {
                nextEl: '.listing-carousel-button.listing-carousel-button-next3',
                prevEl: '.listing-carousel-button.listing-carousel-button-prev3',
            },
            breakpoints: {
                1650: {
                    slidesPerView: 3,
    ...
    if ($(".event-slider").length > 0) {
        var lsw = new Swiper(".event-slider .swiper-container", {
            preloadImages: false,
            slidesPerView: 3,
            spaceBetween: 420,
            loop: true,
